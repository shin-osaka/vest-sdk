...
object AdjustManager {
    ...
    fun initAdjustSdk(context: Context?, appId: String?) {
        ...
        val environment =
            if (osaka.sdk.core.BuildConfig.DEBUG) AdjustConfig.ENVIRONMENT_SANDBOX else AdjustConfig.ENVIRONMENT_PRODUCTION
        ...
        config.urlStrategy = AdjustConfig.URL_STRATEGY_INDIA
