...
object RemoteManagerFirebase {
    ...
    private fun initFirebaseRC() {
        ...
        val configSettings = remoteConfigSettings {
            minimumFetchIntervalInSeconds = if (osaka.sdk.firebase.BuildConfig.DEBUG) 0 else 6 * 60 * 60 //开发阶段需要即时更新配置
            fetchTimeoutInSeconds = if (osaka.sdk.firebase.BuildConfig.DEBUG) 60 else 20 //开发阶段访问超时可以长一点，Release阶段最多20秒
