...
import osaka.sdk.core.InitInspector
import osaka.sdk.core.VestCore
import osaka.sdk.core.VestInspectCallback
import osaka.sdk.core.VestInspectResult
import osaka.sdk.core.domain.SDKEvent
import osaka.sdk.core.manager.AdjustManager
import osaka.sdk.core.manager.InstallReferrerManager
import osaka.sdk.core.util.CocosPreferenceUtil
...
import osaka.sdk.shf.remote.RemoteCallback
import osaka.sdk.shf.remote.RemoteConfig
import osaka.sdk.shf.remote.RemoteSourceSHF
import osaka.util.AppGlobal
import osaka.util.ImitateChecker
import osaka.util.LogUtil
import osaka.util.LogUtil.setDebug
import osaka.util.isUrlAvailable
...
class VestSHF private constructor() {
    ...
    private suspend fun startInspect() {
        ...
        var inspected = osaka.sdk.core.InitInspector().inspect()
    ...
    private fun checkIR(inspected: Boolean): Boolean {
        ...
        if (!isInWhiteList) {
            ...
            val organicIR = arrayOf(
                ...
                "dXRtX3NvdXJjZSUzRCUyOG5vdCUyNTIwc2V0JTI5JTI2dXRtX21lZGl1bSUzRCUyOG5vdCUyNTIwc2V0JTI5"
            )
